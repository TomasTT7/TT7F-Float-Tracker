...
# CSV
f1= open('TT7F3data.csv', 'w')
f1.write("""Timestamp,Solar,Supercap,MCU,TX,Satellites,Sequence,Bck,PSM\n""")
...
# KML
f = open('TT7F3data.kml', 'w')

f.write("""<?xml version="1.0" encoding="UTF-8"?>\n""")
f.write("""<kml xmlns="http://earth.google.com/kml/2.0">\n""")
f.write("""<Document>\n""")
f.write("""   <name>{:s}</name>\n""".format(callsign[0]))
f.write("""   <description>The flight path of TT7F3 superpressure balloon.</description>\n""")
...
for i in range(len(dataORDERED)):
    ...
    f.write("""               <Data name="Backlog"><value>{:s}</value></Data>\n""".format(dTemp[18]))
